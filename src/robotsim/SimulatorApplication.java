...
public class SimulatorApplication {
	...
	public static void main(String[] args) {
		...
		room1.addArea(area1);
		final Door door1 = new Door(new Position(50, 200), 50, 5, "Entrance", factory, true, room1, null);
		room1.addDoor(door1);
		...
		room2.addArea(area2);
		final Door door2 = new Door(new Position(300, 75), 5, 50, "Entrance", factory, true, room2, null);
		room2.addDoor(door2);
